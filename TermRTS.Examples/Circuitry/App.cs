...
internal class App : IRunnableExample
{
    ...
    public void Run()
    {
        ...
        var busEntity1 = new EntityBase<CircuitComponentTypes>();
        busEntity1.AddComponent(
            CircuitComponentTypes.Bus,
            new Bus(
                new List<Wire>
                {
                    new Wire(
        ...
        var busEntity2 = new EntityBase<CircuitComponentTypes>();
        ...
        var busEntity3 = new EntityBase<CircuitComponentTypes>();
        ...
        core.AddEntity(busEntity2);
        core.AddEntity(busEntity3);
