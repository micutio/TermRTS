...
public class MapView : UiElementBase, IEventSink
{
    ...
    public MapView(ConsoleCanvas canvas, int worldWidth, int worldHeight, UiThemes theme)
    {
        ...
        _elevationColorVisualizer = new ElevationVisualizer(theme.Elevation.MarkersElevation, theme.Elevation.ColorsElevation);
        _elevationMonochromeVisualizer = new ElevationVisualizer(theme.Elevation.MarkersElevation, theme.Elevation.ColorsElevationMonochrome);
        _heatmapColorVisualizer = new ElevationHeatmapVisualizer(theme.Heatmap.MarkersHeatmapMonochrome, theme.Elevation.ColorsElevation);
        _heatmapMonochromeVisualizer =
            new ElevationHeatmapVisualizer(theme.Heatmap.MarkersHeatmapMonochrome, theme.Elevation.ColorsElevationMonochrome);

        _surfaceFeatureVisualizer = new SurfaceFeatureVisualizer(theme.SurfaceFeature.CellVisualSurfaceFeatures);
        _temperatureVisualizer = new TemperatureVisualizer(theme.Scalar.MarkersScalar, theme.Heatmap.ColorsHeatmapTemperature);
        _humidityVisualizer = new HumidityVisualizer(theme.Scalar.MarkersScalar, theme.Heatmap.ColorsHeatmapHumidity);
        _temperatureAmplitudeVisualizer = new TemperatureAmplitudeVisualizer(theme.Scalar.MarkersScalar, theme.Heatmap.ColorsHeatmapTemperature);
        _biomeVisualizer = new BiomeVisualizer(theme.Biome.BiomeMap);
        _riverVisualizer = new RiverVisualizer(theme.Default.RiverFg, theme.Default.DefaultFg, theme.Default.DefaultBg);
